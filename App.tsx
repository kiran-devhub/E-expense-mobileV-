...
import { LayoutDashboard, Wallet, PlusCircle, PieChart, Settings as SettingsIcon, AlertTriangle, ArrowRightLeft, MoreHorizontal, Landmark, Smartphone, CreditCard, Banknote } from 'lucide-react';
...
export default function App() {
  ...
  useEffect(() => {
    ...
    if (accs.length === 0) {
      // Storage service handles seeding, just force a refresh
      Storage.getAccounts(); 
    }
    refreshData();
  }, []);
            ...
            {type === 'TRANSFER' && (
                <div className="animate-in slide-in-from-top-2">
                   ...
                   <select 
                     ...
                     className="w-full p-4 rounded-xl bg-slate-50 dark:bg-slate-800 border-none outline-none text-slate-800 dark:text-white font-bold border-l-4 border-indigo-500"
                   >
